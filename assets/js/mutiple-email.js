		...
		return this.each(function() {
			...
			if ($(this).val() != '') {
				$.each(jQuery.parseJSON($(this).val()), function( index, val ) {
					$list.append($('<li class="multiple_emails-email"><span class="email-icon"></span><span class="email_name">' + val + '</span></li>')
					  .append($('<a href="#" class="multiple_emails-close" title="Remove"><span class="glyphicon glyphicon-remove"></span></a>')
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left"  placeholder="Enter email address" />').keyup(function(event) { // input
